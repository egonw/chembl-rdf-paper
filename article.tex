...
other classes defined by several ontologies for these types. For example, proteins subclass the
...
The following SPARQL query returns the 44,681 ChEMBL documents. This is one fewer than appears 
...
the IC$_{50}$ and K$_i$ end points are closely related, but that is currently not
