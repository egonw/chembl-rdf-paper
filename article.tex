...
Antony~J.~Williams$^4$\email{Antony J. Williams - WilliamsA@rsc.org}\and
...
David~J.~Wild$^7$\email{David J. Wild - djwild@indiana.edu}
}
...
entities, extracted primarily from the scientific literature, providing a unique resource for drug researchers~\cite{Gaulton2012,Warr2009}.
...
Moreover, we triples only give this drug role to approved drugs, as defined by the
ChEMBL database. 
