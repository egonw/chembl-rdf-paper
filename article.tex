...
Although many parts of the CHEMBL-RDF dataset use community based ontologies, some 
terms from the previous ontology are still used. These terms were created under the 
