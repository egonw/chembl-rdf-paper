...
exposing ChEMBL as RDF (EW, PA). Different versions may arise which expose the data using different ontologies,
supporting current community needs, however, convergence is expected after a period of experimenting with ontologies that
are not practically useful. The availability of Open Source scripts ensures that the community can contribute to the
